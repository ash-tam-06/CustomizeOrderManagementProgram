...
//
#include "OrderManagement/setupProducts.hpp"// to access setupProducts since it is in the folder OrderMangement

#include "OrderManagement/setupCustomerFields.hpp" // to access setupCustomerFields since it is in the folder OrderMangement
#include "OrderManagement/menu.hpp"  // to access menu since it is in the folder OrderMangement
